module.exports = {
    ...
    server: {
        guildId: '1439168657526755339',         // ايدي السيرفر
        broadcastRoleId: '1439181060666691695', // ايدي الرول اللي يستخدم عليها البوت
        reportChannelId: '1445741322672804011' // ايدي الروم اللي يرسل فيه البوت التقارير
    },
    broadcast: {
